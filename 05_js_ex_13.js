...
/*
  객체( Object ) : 하나의 독립된( 정적인 것 ) 속성, 기능( 동적인 것 )을 할 수 있는 대상

  1. 현실에서의 객체

      객체의 종류 : 자동차, 동물, 스마트폰..( 현실에서의 객체 )
  ...
  2.코딩에서의 객체
      ...
      객체의 Property 와 Method 는 해당 객체의 전용으로 사용됨

 */

// 객체 선언
// var 객체이름 = { property Name : property Value, methodName : function(){} };
...
(function(){
  ...
  /*
   객체 property 에 객체 내부에서의 접근외 다른 곳에서 직접 접근하는 것을
